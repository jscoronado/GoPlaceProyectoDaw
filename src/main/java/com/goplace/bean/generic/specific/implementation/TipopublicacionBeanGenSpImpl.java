...
public class TipopublicacionBeanGenSpImpl extends BeanGenImpl implements BeanInterface {
    @Expose
    private String tipo = "";

    public TipopublicacionBeanGenSpImpl() {

    }

    public TipopublicacionBeanGenSpImpl(Integer id) {
        super(id);
    }
