...
<form class="form-horizontal" role="form" action="#" id="ciudadForm" name="formulario">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">              
            <input readonly="true" class="form-control"  id="obj_ciudad_id" class="input-mini" name="id_ciudad_1" type="text" size="5" maxlength="5" />  
        </div>
        <div class="col-sm-1">              
