...
<%@page import="com.goplace.dao.generic.specific.implementation.AmistadDaoGenSpImpl"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    ArrayList<String> alColumnsNames;
    Iterator<String> oIterador;
    String strNombreMantenimiento = "tipopublicacion";
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">                                 
                                ...
                                <div class="panel-body">
                                    <br />
                                    <div class="text-center">
                                        <a class="btn btn-primary" href='control#/<%=strNombreMantenimiento%>/new'>Crear un nuevo <%=strNombreMantenimiento%></a> 
                                    </div>
                                    <br />
                                </div>
                            </div>
