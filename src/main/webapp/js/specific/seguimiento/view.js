...
asistenciaView.prototype.loadButtons = function (id, id_usuario_1) {
...
asistenciaView.prototype.doEventsLoading = function () {
    ...
    $('#asistenciaForm #obj_publicacion_button').unbind('click');
    $("#asistenciaForm #obj_publicacion_button").click(function () {
        var oControl = oPublicacionControl;  //para probar dejar documento
        //vista('usuario').cargaModalBuscarClaveAjena('#modal01', "documento");
...
asistenciaView.prototype.printValue = function (value, valor, recortar) {
    var thisObject = this;
    var strResult = "";
